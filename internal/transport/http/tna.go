...
type QuestionSetService interface {
	GetQuestionSet(ctx context.Context, technologyName string) (tna.QuestionSet, error)
	GetQuestionSetByTechName(ctx context.Context, technologyName string) (tna.QuestionSet, error)
	GetAllQuestionSets(ctx context.Context, page int, pageSize int) ([]tna.QuestionSet, error)
	PostQuestionSet(ctx context.Context, questionSet tna.QuestionSet) (tna.QuestionSet, error)
	UpdateQuestionSet(ctx context.Context, questionSet tna.QuestionSet) (tna.QuestionSet, error)
